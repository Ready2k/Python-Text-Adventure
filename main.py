        ...
        while True:
            ...
            try:
                ...
                if player.weapon == self.equipment[intchoice].name or \
                    ...
                    confirm = input('Would you like to unequip the %s? > ' %
                                        self.equipment[intchoice].name).lower()
                    if 'yes' in confirm:
                        self.equipment[intchoice].unequip()
                        break
                else:
                    confirm = input('Would you like to equip the %s? > ' %
                                        self.equipment[intchoice].name).lower()
                    if 'yes' in confirm:
    ...
    def use_item(self, enemy):
        ...
        while not player.used_item:
            ...
            try:
                ...
                confirm = input('Would you like to use the %s? > ' %
...
def victory(player, enemy):
    ...
    if player.player_class == 'mage':
        ...
        if player.mana > player.max_mana:
            player.mana = player.max_mana
        input('%s regains %d HP, %d MP, gains %d gold, and gains %d '
        ...
        if player.hp > player.max_hp:
            player.hp = player.max_hp
        input('%s regains %d HP, gains %d gold, and gains %d experience! > '
